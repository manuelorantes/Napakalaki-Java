...
public class Player {
    ...
    protected boolean shouldConvert(){
        ...
        int numero;
        numero = dado.nextNumber(name + " a pesar de haber perdido","Si sacas un 6 te conviertes en sectario");
        return (numero == 6);
    }
    ...
    public void initTreasures(){
        ...
        int number = dice.nextNumber("Tira el dado " + name + " si sacas...","1 -> 1 tesoro   2,3,4,5 -> 2 tesoros   6 -> 3 tesoros");
